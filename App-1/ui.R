  ...
  sidebarLayout(
    sidebarPanel(
      ...
      conditionalPanel(condition="input.distType=='Multivariate'&&input.dist2=='Multinomial'",
                       ...
                       sliderInput("multinomial_prob1","probability 1",min=0,max=1,value=0.5),
                       sliderInput("multinomial_prob2","probability 2",min=0,max=1,value=0.5),
                       sliderInput("multinomial_prob3","probability 3",min=0,max=1,value=0.5)),
